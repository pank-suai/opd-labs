...
#let init(body) = {
  titlepage(authors: ("В.Д. Панков", "Д.И. Скороходов"), city: "Санкт-Петербург", department: "Кафедра № 1", documentName: "3 Ответы на вопросы по теме 3", education: "ГУАП", group: "М412", teachers: ("Е.Ю. Москвина",), position: "канд. техн. наук, доцент")
