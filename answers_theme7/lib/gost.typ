...
#let init(body) = {
  titlepage(authors: ("В.Д. Панков", ), city: "Санкт-Петербург", department: "Кафедра № 1", documentName: "Ответы на вопросы по теме 7", education: "ГУАП", group: "М412", teachers: ("Е.Ю. Москвина",), position: "канд. техн. наук, доцент", object: "Основы проектной деятельности")
