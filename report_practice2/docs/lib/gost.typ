...
#let init(body) = {
  titlepage(authors: ("В.Д. Панков", "Д.И. Скороходов"), city: "Санкт-Петербург", department: "Кафедра № 1", documentName: "Отчет по практической работе 2", education: "ГУАП", group: "М412", teachers: ("Е.Ю. Москвина",), position: "канд. техн. наук, доцент")
