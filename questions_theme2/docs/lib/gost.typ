...
#let init(body) = {
  titlepage(authors: ("В.Д. Панков", "Д.И. Скороходов"), city: "Санкт-Петербург", department: "Кафедра № 1", documentName: "2 Вопросы и задания по теме 2", education: "ГУАП", group: "М412", teachers: ("Е.Ю. Москвина",), position: "канд. техн. наук, доцент")
